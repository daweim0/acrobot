 ...
 */
typedef __pyx_t_5numpy_int_t __pyx_t_11cython_test_DTYPE_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
static CYTHON_INLINE int __pyx_f_11cython_test_int_max(int, int); /*proto*/
static CYTHON_INLINE int __pyx_f_11cython_test_int_min(int, int); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_11cython_test_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_11cython_test_DTYPE_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_11cython_test_DTYPE_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_11cython_test_DTYPE_t), 0 };
...
static PyObject *__pyx_pf_11cython_test_naive_convolve(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_f, PyArrayObject *__pyx_v_g); /* proto */
...
static char __pyx_k_home_david_pycharm_acrobot_simu[] = "/home/david/pycharm/acrobot-simulation/pyode/src/cython_test.pyx";
...
static CYTHON_INLINE int __pyx_f_11cython_test_int_max(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
...
static CYTHON_INLINE int __pyx_f_11cython_test_int_min(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
...
/* Python wrapper */
static PyObject *__pyx_pw_11cython_test_1naive_convolve(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_11cython_test_1naive_convolve = {"naive_convolve", (PyCFunction)__pyx_pw_11cython_test_1naive_convolve, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_11cython_test_1naive_convolve(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_test.naive_convolve", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_11cython_test_naive_convolve(__pyx_self, __pyx_v_f, __pyx_v_g);
...
static PyObject *__pyx_pf_11cython_test_naive_convolve(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_f, PyArrayObject *__pyx_v_g) {
  int __pyx_v_vmax;
  int __pyx_v_wmax;
  int __pyx_v_smax;
  int __pyx_v_tmax;
  ...
  int __pyx_v_t_from;
  int __pyx_v_t_to;
  __pyx_t_11cython_test_DTYPE_t __pyx_v_value;
  ...
  __pyx_pybuffernd_g.rcbuffer = &__pyx_pybuffer_g;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_f.rcbuffer->pybuffer, (PyObject*)__pyx_v_f, &__Pyx_TypeInfo_nn___pyx_t_11cython_test_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_g.rcbuffer->pybuffer, (PyObject*)__pyx_v_g, &__Pyx_TypeInfo_nn___pyx_t_11cython_test_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_h.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_11cython_test_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
      __pyx_v_s_from = __pyx_f_11cython_test_int_max((__pyx_v_smid - __pyx_v_x), (-__pyx_v_smid));
 ...
 */
      __pyx_v_s_to = __pyx_f_11cython_test_int_min(((__pyx_v_xmax - __pyx_v_x) - __pyx_v_smid), (__pyx_v_smid + 1));
 ...
 *             value = 0
 */
      __pyx_v_t_from = __pyx_f_11cython_test_int_max((__pyx_v_tmid - __pyx_v_y), (-__pyx_v_tmid));
 ...
 */
      __pyx_v_t_to = __pyx_f_11cython_test_int_min(((__pyx_v_ymax - __pyx_v_y) - __pyx_v_tmid), (__pyx_v_tmid + 1));
 ...
 */
          ...
          __pyx_v_value = (__pyx_v_value + ((*__Pyx_BufPtrStrided2d(__pyx_t_11cython_test_DTYPE_t *, __pyx_pybuffernd_g.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_g.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_g.diminfo[1].strides)) * (*__Pyx_BufPtrStrided2d(__pyx_t_11cython_test_DTYPE_t *, __pyx_pybuffernd_f.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_f.diminfo[0].strides, __pyx_t_19, __pyx_pybuffernd_f.diminfo[1].strides))));
        }
      }
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_11cython_test_DTYPE_t *, __pyx_pybuffernd_h.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_h.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_h.diminfo[1].strides) = __pyx_v_value;
    }
  }
 ...
 */
  ...
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(2, 0, 22, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_david_pycharm_acrobot_simu, __pyx_n_s_naive_convolve, 33, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *         raise ValueError("Only odd dimensions on filter supported")
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_11cython_test_1naive_convolve, NULL, __pyx_n_s_cython_test); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
