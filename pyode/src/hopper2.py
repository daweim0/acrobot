...
def main(name):
    ...
    try:
        ...
        print
        print
        print 'ended up', dist, 'away from target at :', location_angles, 'target:',
        ...
        for i in range(0, len(path)):
            if not isinstance(path[i][0], tuple):
                ...
                if isinstance(path[i][0], types.ListType) and len(path[i][0]) == 5:
                    print path[i][0][4],
...
def start_search_single_step(
    ...
    total_path = list()
    for _i in xrange(0, repetitions):
        ...
        if print_on:
            print
            print 'finnished tree, moving to ',
        ...
        if print_on:
            ...
            if verbose:
                ...
                print_tupple(
                    ...
                    new_line=False)
                print ' with distance ' + str('{0:.4f}'.format(distance)),
        ...
        for iteration in range(0, n_iterations):
            ...
            if print_on:
                ...
                for _i in range(0, initial_level - recursive_level):
                    print '\t',
                print '  starting new level ' + str(recursive_level),
                # print_tupple(recursive_level, new_line = False),
                print(' at  '),
            ...
            for torque_val in torque_vals:
                ...
                if print_on and verbose:
                    for _i in range(0, initial_level - recursive_level):
                        print "\t  ",
                    print ' applying torque: ' + str(torque_val) + ' from level ' + str(recursive_level),
